...
# train_data = [train_data[i] for i in range(10000)]
# test_data = [test_data[i] for i in range(1000)]
...
if __name__ == '__main__':
    ...
    # 不允许序列化
    np.save('out/AlexNet_b16_p5_output.npy', output_array, allow_pickle=False)
    np.save('out/AlexNet_b16_p5_target.npy', target_array, allow_pickle=False)
    ...
    # data_array = np.concatenate(out_data, axis=0)
    # 不允许序列化
    np.save('out/AlexNet_b16_p5_test_output.npy',
            output_array,
            allow_pickle=False)
    np.save('out/AlexNet_b16_p5_test_target.npy',
            target_array,
            allow_pickle=False)
